...
![image](images/images2/66/n1.PNG)

 ![image](images/images2/64/02.PNG)

-

![image](images/images2/64/03.PNG)

#### 读的时候是这个逻辑，写的时候并不是

![image](images/images2/64/04.PNG)



![image](images/images2/66/n3.PNG)
...
![image](images/images2/64/01.PNG)
...
![image](images/images2/66/1.PNG)

![image](images/images2/66/2.PNG)

![image](images/images2/64/05.PNG)

`prototype` 和` __proto__ `区别是什么？

- 都存着原型的地址，只不过 `prototype` 挂在函数上， `__proto__` 挂在每个新生成的对象上。

![image](images/images2/66/n17.PNG)
...
![image](images/images2/64/06.PNG)
...
![image](images/images2/64/07.PNG)
...
![image](images/images2/64/08.PNG)
...
![image](images/images2/64/09.PNG)
...
![image](images/images2/64/10.PNG)
