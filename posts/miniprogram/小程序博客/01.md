...
这里的 `index.json` 其实用来表示 pages/index目录下的 `index.json` 这类和小程序页面相关的配置。
...
参考文档 [小程序的API](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/api.html) 。
