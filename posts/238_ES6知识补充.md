...
![image](images/images7/238/01.png)
...
![image](images/images7/238/02.png)
...
* 那么是不是意味着 foo 变量只有在代码执行阶段才会创建的呢？
  ...
  * 这些变量会被创建在包含他们的词法环境被实例化时，但是是不可以访问它们的，直到词法绑定被赋值；
  ...
  ![image](images/images7/238/03.png)
...
![image](images/images7/238/04.png)
...
![image](images/images7/238/05.png)
...
![image](images/images7/238/06.png)
